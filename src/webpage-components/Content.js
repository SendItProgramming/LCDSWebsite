...
export default class Content extends Component {
	...
	GetStaff(){
		fetch("http://localhost:8888/staff/")
		.then(res => res.json())
		.then(
		  (result) => {
				console.log("staff grabbed")
				this.setState({
					staff: result
				})
		  },
	...
	OurStaff(){
		...
		return(
			<div className="info">
					<p className="fun">Our Staff Members</p>
					<div>
						<table className="Table">
						<tbody>
							...
							{items.map(item => (
								...
								<tr className="staffTable">
									<div>
										<div className="container-left">
											<Image src={require(`./../images/Staff/${item.PictureURL}.jpg`)}/>
										</div>
